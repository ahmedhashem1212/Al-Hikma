...
const HomeFR = () => {
	...
	const Veg = [

		{
            ...
            desc:"Les pommes de terre sont l'un des produits frais que l'Égypte s'est spécialisée dans la culture, le conditionnement et l'exportation dans de nombreuses régions du monde. La Spunta est une pomme de terre très conventionnelle et bien connue, adaptée à la production sous de nombreux climats.",
            type:"Spunta",
		...
		},
		{
            ...
            desc:"La laitue iceberg fournit des quantités importantes de vitamines A et K. Elle contient également de petites quantités de nombreux autres nutriments sains. Il fournit également du calcium, du potassium, de la vitamine C et du folate.",
            type:"laitue iceberg",
		...
		{
			name:"Ail",
            desc:"En Egypte, l'ail est très compétitif sur le marché international par rapport aux autres pays. Il a commencé à être exporté vers les pays du monde entier, l'ail égyptien est une excellente source de vitamines C et B6, de sélénium et de manganèse, et contient également des fibres, phosphore, potassium, calcium, fer et cuivre.",
            type:"ail frais",
		...
		{
			name:"Haricots verts",
            desc:"Les haricots verts sont consommés dans le monde entier et vendus frais. Ils peuvent être consommés crus ou cuits à la vapeur, bouillis, sautés ou cuits au four. Nous exportons les haricots verts égyptiens pour plusieurs pays avec une bonne qualité et emballage.",
		...
		{
			name:"Oignons",
            desc:"L'un des trois principaux produits exportateurs d'Égypte, pour de nombreuses régions du monde. Nous avons les oignons rouges et les oignons bruns.",
	...
	const Fruits = [
		...
		{
			name:"Raisins",
            desc:"Les raisins sont une bonne source de fibres, de potassium et d'une gamme de vitamines et d'autres minéraux. Nous exportons 3 célèbres variétés de raisins égyptiens: Flame, Superior et Crimson.",
		...
		{
			name:'Pastèques',
			desc:"Généralement, la pastèque a une teneur élevée en eau et est l'une des plus faibles en calories. La principale variété de pastèque en Égypte est Skata.",
            type:"Skata",
		...
		{
			name:'Citron',
            desc:"Les citrons sont un type d'agrumes à peau jaune qui poussent sur le citronnier. Tous les types de citrons sont connus pour leur goût acide et acidulé, certaines variétés étant plus sucrées que d'autres. En fait, nous exportons actuellement le citron égyptien pour de nombreux pays.",
            type:"Citron Adalia",
		...
		{
			name:'Grenade',
            desc:"Les grenades sont parmi les fruits les plus sains au monde. Les grenades sont une source de fibres, de vitamines B, de vitamine C, de vitamine K et de potassium.",
            type:"Wonderful",
	...
	return (
		...
		{matches?(	
			...
			<div>
			<div>
				<h1 style={{paddingLeft:'15rem', paddingTop:'5rem'}}>légumes </h1>
...
<Card style={{
  ...
  <Card.Title style={{fontSize:"20px", color:'green',fontFamily:'Trebuchet-MS'}}>Type</Card.Title>
	<Card.Text>
	 ...
	 <Card.Title style={{fontSize:"20px", color:'green',fontFamily:'Raleway'}}>Emballage</Card.Title>
	<Card.Text>
	 {item.Packing}
	 </Card.Text>
